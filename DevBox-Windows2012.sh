...
mkdir W10Nosware
cd W10Nosware
wget -O Nosware.vhd https://drive.google.com/uc?export=download&confirm=xnXy&id=1zIUDyzSfRZtEye5fQKo0fxHjp_bWPHMA
clear
...
vboxmanage storageattach W10 --storagectl "SATA Controller" --device 0 --port 0 --type hdd --medium /home/developer/W10Nosware/Nosware.vhd
